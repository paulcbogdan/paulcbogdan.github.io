...
Jekyll::Hooks.register :pages, :post_render do |page|
  ...
  if page.path.include?('publications')
    ...
    page.output = page.output.gsub('<h2 class="bibliography">submitted</h2>', '<h2 class="bibliography">Preprints</h2>')  # Jekyll Scholar converts 9997 to "submitted"
    page.output = page.output.gsub('<h2 class="bibliography">9997</h2>', '<h2 class="bibliography">Preprints</h2>')  # Just in case
